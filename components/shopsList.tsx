...
const ShopsList: React.FC<Props> = (props) => {
    ...
    return(
        <View style = {styles.container}>
            <TextInput placeholder = {'Enter shop name'} onChangeText = {(event: any) =>  filterShops(event, props.markers, setShops, isOnlyFavorite)}></TextInput>
            ...
            { shops.map( (shop: any, index: number) => {
               ...
               return(
                <View key = {index}>
                    <Text >Name: {shop.name}, type: {shop.shopType}</Text>
